(function(angular){
    ...
    angular.module( 'page', [] ).directive('page',[function(){
        return {
            restrict: 'EA',
            ...
            '第<input type="text" ng-model="jumpPageNum"  ng-blur="jumpToPage($event)" ng-keydown="keydown($event)"/>页 ' +
            ...
            link: function(scope, element, attrs){
                ...
                scope.changeCurrentPage = function(item) {
                    var totalPages  = Math.floor(scope.conf.totalItems/scope.conf.pagesLength);
                    if(item == '...'){
                        return;
                    }else{
                        if(item > totalPages){
                        ...
                        scope.clickFn(item, scope.conf.itemsPerPage )
